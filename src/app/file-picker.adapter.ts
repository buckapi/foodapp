    ...
    .pipe(
      map( (res: HttpEvent<any>) => {
          if (res.type === HttpEventType.Response) {
            this.yeoman.newImage=true;
          this.yeoman.productImages.push('https://db.buckapi.us/api/server/local-storage/tixsImages/'+res.body.result.files.file[0].name);
          this.yeoman.newProductImage=true;

...
dirSwitch?.addEventListener("change", (e) => {
  ...
  if (checkbox.checked) {
    ...
    rtlLink.href = "assets/radarfood/css/vendors/bootstrap.rtl.min.css";
    localStorage.setItem("rtlcss", "assets/radarfood/css/vendors/bootstrap.rtl.min.css");
    localStorage.setItem("dir", "rtl");
  }

  if (!checkbox.checked) {
    htmlDom.setAttribute("dir", "ltr");
    rtlLink.href = "assets/radarfood/css/vendors/bootstrap.min.css";
    localStorage.setItem("rtlcss", "assets/radarfood/css/vendors/bootstrap.min.css");
    localStorage.setItem("dir", "ltr");
  }
});
// Rtl
htmlDom.setAttribute("dir", localStorage.getItem("dir") ? localStorage.getItem("dir") : "ltr");
rtlLink.href = localStorage.getItem("rtlcss") ? localStorage.getItem("rtlcss") : "assets/radarfood/css/vendors/bootstrap.min.css";
